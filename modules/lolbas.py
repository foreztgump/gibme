...
def _lolbas_parse_info(client, exe_name):
    ...
    for command in data['Commands']:
        ...
        print(colors("Description:", 'white'), colors(f"\t{command['Description']}", 'yellow'))
        print(colors("Usecase:", 'white'), colors(f"\t{command['Usecase']}", 'yellow'))
        print(colors("Category:", 'white'), colors(f"\t{command['Category']}", 'yellow'))
        print(colors("Privileges:", 'white'), colors(f"\t{command['Privileges']}", 'yellow'))
        print(colors("MitreID:", 'white'), colors(f"\t{command['MitreID']}", 'yellow'))
        print(colors("OperatingSystem:", 'white'), colors(f"\t{command['OperatingSystem']}", 'yellow'))
    ...
    for acknowledgement in data['Acknowledgement']:
        print(colors("Person:", 'white'), colors(f"\t{acknowledgement['Person']}", 'green'))
        print(colors("Handle:", 'white'), colors(f"\t{acknowledgement['Handle']}", 'green'))